						...
						<td>
							<table class="table table-bordered" style="margin-bottom:0px">
								...
								while($l = mysqli_fetch_array($linguistik)){
									...
									// $a <= $nilai[$x]  || $nilai[$x] <= $b
									if($a >= $nilai[$x]  || $nilai[$x] <= $b){ ?> <!-- ini untuk nilainya si Terkadang atau Sering -->
									<!-- klasifikasi antara terkadang sama sering	 -->
										<?php if($a >= $nilai[$x] || $nilai[$x] >= $c){ ?>
										<tr>
										...
										<?php }elseif($nilai[$x] >= $a || $nilai[$x] >= $b ){ ?>
											<tr>
											<td width="14%"><?php echo $l['vl_nama']; ?></td>
											<td width="1%">=</td>
											<td>
									...
									<!-- end klasifikasi terkadang atau sering -->
									<?php }elseif($a <= $nilai[$x]  || $nilai[$x] <= $b){ ?>
